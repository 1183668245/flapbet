...
function updatePageMeta(language) {
    const metaData = {
        ...
        zh: {
            title: 'FlapBet - 基于BSC的去中心化预测平台',
            description: 'FlapBet - 基于BSC的去中心化预测平台，体验体育、加密货币、电竞等多元化预测游戏',
            keywords: '预测平台,BSC,DeFi,区块链,体育预测,加密货币,电竞',
            ogTitle: 'FlapBet - 趣味预测平台',
...
function getTranslations() {
    return {
        en: {
            ...
            'hero-title': 'Where Memes Meet Money™',
            ...
            'copyright-text': '© 2025 FlapBet All Rights Reserved',
        ...
        zh: {
            ...
            'hero-title': '梗与金钱的交汇™',
            'hero-description': '全球首个以梗文化为核心的去中心化预测与娱乐竞猜平台。',
            ...
            'copyright-text': '© 2025 FlapBet 版权所有',
